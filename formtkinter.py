#  Simple GUI login form ( without avatar(images) ) in tkinter using Sqlite3 database in Python3
...
def nextwindow():
    ...
    button4 = Button(win4, text="Exit", font=(
        "Monospace", 15, "bold"), command=win4exit, bg="red", fg="white").place(x=300, y=250)
...
button1 = Button(root, text="Sign in", font=(
    "Monospace", 15, "bold"), command=opensignin, bg="blue", fg="white", width=10).place(x=326, y=350)
button2 = Button(root, text="New User? Register", font=(
    "Monospace", 15, "bold"), command=openregister, bg="green", fg="white").place(x=100, y=350)

button31 = Button(root, text="Exit", font=(
    "Monospace", 15, "bold"), command=rootexit, bg="red", fg="white", width=10).place(x=480, y=350)
